                ...
                <table id="example1" class="table table-bordered table-hover dataTable dtr-inline"
                    ...
                    @foreach ($profils as $profil)
                      <tr>
                        ...
                        <td class="text-center">{{ \Carbon\Carbon::createFromTimeStamp(strtotime($profil->tanggal_lahir))->format('d/m/Y') }} </td>
                        <td class="text-center">
                        <div class="d-flex justify-content-center">
                        <a href="{{ route('profil.edit',$profil->id) }}" class="btn btn-sm btn-warning mx-1"><i class="fa fa-edit"></i> Edit</a>
